...
config = dict(
    ...
    # scene_path='experiments/TUM/freiburg3_long_office_household_seed0/params.npz',
    ...
    ##  BetterKF
    # kf_selection=dict(
    #     kf_translation_ratio=0.05,  # 平移率，一般和depth中值配合使用
    #     # kf_min_translation=0.005,  # 平移
    #     keyframe_overlap=0.98,  # 重叠度
    #     min_kf_interval=10,  # 最大间隔
    #     min_kf_gap=4,  # 最小间隔
    #     angle_threshold=0.087  # 弧度，对应5度
    # ),
    kf_selection = dict(
        kf_translation_ratio = 0.09,
        keyframe_overlap     = 0.98,
        min_kf_interval      = 8,
        min_kf_gap           = 4,
        angle_threshold      = 0.013  # ~5°
    ),
