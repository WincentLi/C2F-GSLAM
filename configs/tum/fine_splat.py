...
scenes = ["freiburg1_desk", "freiburg1_desk2", "freiburg1_room", "freiburg2_xyz", "freiburg3_long_office_household",
          "freiburg666_garage", "freiburg667_lab"]
...
group_name = "TUM_Better_Fine_3DGS_6k"
...
config = dict(
    ...
    data=dict(
        ...
        gradslam_data_cfg=f"./configs/data/TUM/{scene_name}.yaml",  # 注意这里的yaml文件
